...
import { Layers, GraduationCap, ArrowRight, BookOpen, AlertCircle } from "lucide-react";
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
      ...
      {loading ? (
        ...
        <div className="card" style={{ textAlign: "center", padding: "3rem" }}>
          ...
          <h3 style={{ fontSize: "1.1rem", fontWeight: 700, marginBottom: "0.5rem" }}>No Subjects Enrolled</h3>
          <p style={{ color: "var(--color-text-muted)", fontSize: "0.875rem" }}>
            You do not have any enrolled subjects mapped to your batch in the database.
          </p>
        </div>
      ) : (
            ...
            <div key={subj.id} className="card" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
              <div>
                ...
                <p style={{ fontSize: "0.85rem", color: "var(--color-text-muted)", lineHeight: "1.5", marginBottom: "1rem" }}>
                  {subj.description || "Core discipline syllabus aligned with academic program standards."}
                </p>
              </div>
              ...
              <div>
                ...
                <div style={{ padding: "0.75rem", borderRadius: "8px", background: "#f8fafc", border: "1px solid #e2e8f0", marginBottom: "1rem" }}>
                  ...
                  <div style={{ fontSize: "0.75rem", color: "var(--color-text-muted)" }}>
                    {subj.teachers?.[0]?.specialization || "Faculty Member"}
                  </div>
                </div>
